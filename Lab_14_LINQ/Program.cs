...
namespace Lab_14_LINQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var db = new Northwind())
            {
                ...
                Console.WriteLine("\n\nCreate custom object output\n" +
                    "==================================================================n");
                var selectedCustomers2 = (from customer in db.Customers where
                ...
                foreach (var c in selectCustomers5.ToList())
                {
        ...
        {
            customers.ForEach(c => Console.WriteLine($"{c.CustomerID, -10}" + $"{c.ContactName, -30}" + $"{c.CompanyName,-30}" + $"{c.City,-30}"));
        }
    }
